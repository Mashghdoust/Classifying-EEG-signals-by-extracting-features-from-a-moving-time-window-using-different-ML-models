...
temp2=zeros(n_channels*n_features,n_trials);
features=zeros(n_channels*n_features,n_trials,s_point);
...
for k=1:s_point
    for m=1:n_trials
        ...
        for j=1:n_channels
            ...
            channel_j_features=myFeatureExtarction(x_train((k:k+kernel_size-1),j,m));
